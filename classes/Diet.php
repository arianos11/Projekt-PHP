<?php
    ...
    class Diet {
        ...
        public static function addDiet($name, $price, $description) {

            $sqlTypes = ['name' => $name, 'price' => $price, 'description' => $description];
            $query = "INSERT INTO diets(diet_name, diet_price, diet_description) VALUES (:name, :price, :description)";
            $sql = $GLOBALS['db']->query($query, $sqlTypes);
            return $sql;
